...
class ShipmentAxd(object):
    ...
    file_name = '/data/shipment_hehegu_12.csv'
    ...
    def run(self, **kwargs):
        ...
        self.shipment_list = []
        self.get_shipments(**kwargs)#查询单子，并写入库
        # self.read_mongdb() #查询库，后写入文档
        # self.set_csv()  #查询库，后写入文档
    ...
    def read_mongdb(self):
        ...
        db = conn.aoao
        # print params[1],params[2],params[23],"83"
        print db.shipment12.find().count(),"100"
        for shipment in db.shipment12.find():
